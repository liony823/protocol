...
const (
	...
	Friend_BlockUser_FullMethodName                      = "/openim.relation.friend/blockUser"
	Friend_UnblockUser_FullMethodName                    = "/openim.relation.friend/unblockUser"
	Friend_FollowUser_FullMethodName                     = "/openim.relation.friend/followUser"
	Friend_UnfollowUser_FullMethodName                   = "/openim.relation.friend/unfollowUser"
	Friend_SubscribeUser_FullMethodName                  = "/openim.relation.friend/subscribeUser"
	Friend_UnsubscribeUser_FullMethodName                = "/openim.relation.friend/unsubscribeUser"
	Friend_GetFollowerIDs_FullMethodName                 = "/openim.relation.friend/getFollowerIDs"
	Friend_GetSubscriberIDs_FullMethodName               = "/openim.relation.friend/getSubscriberIDs"
)
...
func (c *friendClient) FollowUser(ctx context.Context, in *FollowUserReq, opts ...grpc.CallOption) (*FollowUserResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_FollowUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) UnfollowUser(ctx context.Context, in *UnfollowUserReq, opts ...grpc.CallOption) (*UnfollowUserResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_UnfollowUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) SubscribeUser(ctx context.Context, in *SubscribeUserReq, opts ...grpc.CallOption) (*SubscribeUserResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_SubscribeUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) UnsubscribeUser(ctx context.Context, in *UnsubscribeUserReq, opts ...grpc.CallOption) (*UnsubscribeUserResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_UnsubscribeUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) GetFollowerIDs(ctx context.Context, in *GetFollowerIDsReq, opts ...grpc.CallOption) (*GetFollowerIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_GetFollowerIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) GetSubscriberIDs(ctx context.Context, in *GetSubscriberIDsReq, opts ...grpc.CallOption) (*GetSubscriberIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_GetSubscriberIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFriendServer) GetFollowerIDs(context.Context, *GetFollowerIDsReq) (*GetFollowerIDsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFollowerIDs not implemented")
}
func (UnimplementedFriendServer) GetSubscriberIDs(context.Context, *GetSubscriberIDsReq) (*GetSubscriberIDsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSubscriberIDs not implemented")
}
...
func _Friend_FollowUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_FollowUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_UnfollowUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_UnfollowUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_SubscribeUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_SubscribeUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_UnsubscribeUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_UnsubscribeUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_GetFollowerIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_GetFollowerIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_GetSubscriberIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_GetSubscriberIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
