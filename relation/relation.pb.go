...
const file_relation_relation_proto_rawDesc = "" +
	...
	"\vfriendInfos\x18\x01 \x03(\v2\x1f.openim.relation.FriendInfoOnlyR\vfriendInfos\"\xfa\x01\n" +
	"\fuserRelation\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\x12\x1c\n" +
	"\tisBlocked\x18\x03 \x01(\x05R\tisBlocked\x12 \n" +
	"\visFollowing\x18\x04 \x01(\x05R\visFollowing\x12\"\n" +
	"\fisSubscribed\x18\x05 \x01(\x05R\fisSubscribed\x12\x1e\n" +
	"\n" +
	"createTime\x18\x06 \x01(\x03R\n" +
	"createTime\x12\x1e\n" +
	"\n" +
	...
	"\fblockUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x0f\n" +
	"\rblockUserResp\"X\n" +
	"\x0eunblockUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x11\n" +
	"\x0funblockUserResp\"W\n" +
	"\rfollowUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x10\n" +
	"\x0efollowUserResp\"Y\n" +
	"\x0funfollowUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x12\n" +
	"\x10unfollowUserResp\"Z\n" +
	"\x10subscribeUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x13\n" +
	"\x11subscribeUserResp\"\\\n" +
	"\x12unsubscribeUserReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rrelatedUserID\x18\x02 \x01(\tR\rrelatedUserID\"\x15\n" +
	"\x13unsubscribeUserResp\"+\n" +
	"\x11getFollowerIDsReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\".\n" +
	"\x12getFollowerIDsResp\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"-\n" +
	"\x13getSubscriberIDsReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\"0\n" +
	"\x14getSubscriberIDsResp\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs2\xbf\x1b\n" +
	"\x06friend\x12_\n" +
	...
	"\rgetFriendInfo\x12!.openim.relation.getFriendInfoReq\x1a\".openim.relation.getFriendInfoResp\x12J\n" +
	"\tblockUser\x12\x1d.openim.relation.blockUserReq\x1a\x1e.openim.relation.blockUserResp\x12P\n" +
	"\vunblockUser\x12\x1f.openim.relation.unblockUserReq\x1a .openim.relation.unblockUserResp\x12M\n" +
	"\n" +
	"followUser\x12\x1e.openim.relation.followUserReq\x1a\x1f.openim.relation.followUserResp\x12S\n" +
	"\funfollowUser\x12 .openim.relation.unfollowUserReq\x1a!.openim.relation.unfollowUserResp\x12V\n" +
	"\rsubscribeUser\x12!.openim.relation.subscribeUserReq\x1a\".openim.relation.subscribeUserResp\x12\\\n" +
	"\x0funsubscribeUser\x12#.openim.relation.unsubscribeUserReq\x1a$.openim.relation.unsubscribeUserResp\x12Y\n" +
	"\x0egetFollowerIDs\x12\".openim.relation.getFollowerIDsReq\x1a#.openim.relation.getFollowerIDsResp\x12_\n" +
	"\x10getSubscriberIDs\x12$.openim.relation.getSubscriberIDsReq\x1a%.openim.relation.getSubscriberIDsRespB(Z&github.com/openimsdk/protocol/relationb\x06proto3"
