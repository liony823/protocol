...
type EditMsgTips struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	EditorUserID   string                 `protobuf:"bytes,1,opt,name=editorUserID,proto3" json:"editorUserID"`
	ClientMsgID    string                 `protobuf:"bytes,2,opt,name=clientMsgID,proto3" json:"clientMsgID"`
	EditTime       int64                  `protobuf:"varint,3,opt,name=editTime,proto3" json:"editTime"`
	...
	IsAdminEdit    bool                   `protobuf:"varint,7,opt,name=isAdminEdit,proto3" json:"isAdminEdit"`
...
func (x *EditMsgTips) GetEditorUserID() string {
	if x != nil {
...
func (x *EditMsgTips) GetSessionType() int32 {
	if x != nil {
		return x.SessionType
	}
	return 0
...
func (x *EditMsgTips) GetIsAdminEdit() bool {
	if x != nil {
		return x.IsAdminEdit
	}
	return false
}

func (x *EditMsgTips) GetNewContent() string {
	if x != nil {
		return x.NewContent
	}
	return ""
...
const file_sdkws_sdkws_proto_rawDesc = "" +
	...
	"\rinviterUserID\x18\f \x01(\tR\rinviterUserID\"\xd4\x01\n" +
	"\x0ePublicUserInfo\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12\x18\n" +
	"\afaceURL\x18\x03 \x01(\tR\afaceURL\x12\x0e\n" +
	"\x02ex\x18\x04 \x01(\tR\x02ex\x12\x14\n" +
	"\x05about\x18\x05 \x01(\tR\x05about\x12\x1a\n" +
	"\bcoverURL\x18\x06 \x01(\tR\bcoverURL\x12\x18\n" +
	"\aaddress\x18\a \x01(\tR\aaddress\x12\x18\n" +
	"\aaccount\x18\b \x01(\tR\aaccount\"\xe0\x02\n" +
	"\bUserInfo\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12\x18\n" +
	"\afaceURL\x18\x03 \x01(\tR\afaceURL\x12\x0e\n" +
	...
	"\x05about\x18\t \x01(\tR\x05about\x12\x1a\n" +
	"\bcoverURL\x18\n" +
	" \x01(\tR\bcoverURL\x12\x18\n" +
	"\aaddress\x18\v \x01(\tR\aaddress\x12\x1c\n" +
	"\tpublicKey\x18\f \x01(\tR\tpublicKey\"\x91\x02\n" +
	...
	"\risAdminRevoke\x18\b \x01(\bR\risAdminRevoke\"\xaf\x02\n" +
	"\vEditMsgTips\x12\"\n" +
	"\feditorUserID\x18\x01 \x01(\tR\feditorUserID\x12 \n" +
	"\vclientMsgID\x18\x02 \x01(\tR\vclientMsgID\x12\x1a\n" +
	"\beditTime\x18\x03 \x01(\x03R\beditTime\x12 \n" +
	"\vsessionType\x18\x04 \x01(\x05R\vsessionType\x12\x10\n" +
	"\x03seq\x18\x05 \x01(\x03R\x03seq\x12&\n" +
	"\x0econversationID\x18\x06 \x01(\tR\x0econversationID\x12 \n" +
	"\visAdminEdit\x18\a \x01(\bR\visAdminEdit\x12\x1e\n" +
	"\n" +
	"newContent\x18\b \x01(\tR\n" +
	"newContent\x12 \n" +
	"\vcontentType\x18\t \x01(\x05R\vcontentType\"\xb1\x03\n" +
	...
	"\rfriendVersion\x18\x03 \x01(\x04R\rfriendVersion\x12(\n" +
	"\x0ffriendVersionID\x18\x04 \x01(\tR\x0ffriendVersionID\"\x87\x01\n" +
	"\x17SubUserOnlineStatusElem\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12,\n" +
	"\x11onlinePlatformIDs\x18\x02 \x03(\x05R\x11onlinePlatformIDs\x12&\n" +
	"\x0elastOnlineTime\x18\x03 \x01(\x03R\x0elastOnlineTime\"b\n" +
...
var file_sdkws_sdkws_proto_goTypes = []any{
	...
	(*EditMsgTips)(nil),                   // 62: openim.sdkws.EditMsgTips
