...
const (
	...
	User_GetUsersTime_FullMethodName                  = "/openim.user.user/getUsersTime"
)
...
func (c *userClient) GetUsersTime(ctx context.Context, in *GetUsersTimeReq, opts ...grpc.CallOption) (*GetUsersTimeResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetUsersTime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) GetUsersTime(context.Context, *GetUsersTimeReq) (*GetUsersTimeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUsersTime not implemented")
}
...
func _User_GetUsersTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUsersTime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
