...
const file_user_user_proto_rawDesc = "" +
	...
	"\vplatformIDs\x18\x03 \x03(\x05R\vplatformIDs\x12&\n" +
	"\x0elastOnlineTime\x18\x04 \x01(\x03R\x0elastOnlineTime\"D\n" +
	...
	"\x0fgetUsersTimeReq\x12\x18\n" +
	"\auserIDs\x18\x02 \x03(\tR\auserIDs\"G\n" +
	"\x10getUsersTimeResp\x123\n" +
	"\btimeList\x18\x01 \x03(\v2\x17.openim.user.onlineTimeR\btimeList2\xde\x17\n" +
	"\x04user\x12Z\n" +
	...
	"\x14pageUserClientConfig\x12$.openim.user.pageUserClientConfigReq\x1a%.openim.user.pageUserClientConfigResp\x12K\n" +
	"\fgetUsersTime\x12\x1c.openim.user.getUsersTimeReq\x1a\x1d.openim.user.getUsersTimeRespB$Z\"github.com/openimsdk/protocol/userb\x06proto3"
